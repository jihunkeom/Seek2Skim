...
class Seek2SkimTrainer(Seq2SeqTrainer):
    ...
    def evaluate(
        ...
        **gen_kwargs
        ...
        ####
        # output.metrics["relative_flops"] = round(self.model.relative_flops / self.model.num_instances, 5)
        ...
        # output.metrics["encoder_flops"] = round(self.model.encoder_flops / self.model.num_instances, 5)
        # output.metrics["decoder_flops"] = round(self.model.decoder_flops / self.model.num_instances, 5)
        # output.metrics["all_flops"] = round(self.model.all_flops / self.model.num_instances, 5)
        # self.model.reset_stats()
        ###
